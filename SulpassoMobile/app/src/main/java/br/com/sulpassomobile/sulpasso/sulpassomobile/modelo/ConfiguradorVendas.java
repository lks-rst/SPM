...
public class ConfiguradorVendas
{
    ...
    {
        this.gerenciarVisitas = (venda.getInt("gerenciarVisitas") == 0 ? true : false);
        this.venderDevedores = (venda.getInt("venderDevedores") == 0 ? true : false);
        this.alteraNaturezaInicio = (venda.getInt("alteraNaturezaInicio") == 0 ? true : false);
        this.alteraNaturezaFim = (venda.getInt("alteraNaturezaFim") == 0 ? true : false);
        this.alteraPrazoInicio = (venda.getInt("alteraPrazoInicio") == 0 ? true : false);
        this.alteraPrazoFim = (venda.getInt("alteraPrazoFim") == 0 ? true : false);
        this.recalcularPreco = (venda.getInt("recalcularPreco") == 0 ? true : false);
        this.alteraPrecos = (venda.getInt("alteraPrecos") == 0 ? true : false);
        this.limiteCredito = (venda.getInt("limiteCredito") == 0 ? true : false);
        this.tipoFlex = (venda.getInt("tipoFlex") == 0 ? true : false);
        this.flexVenda = (venda.getInt("flexVenda") == 0 ? true : false);
        this.flexItem = (venda.getInt("flexItem") == 0 ? true : false);
        this.controlaEstoque = (venda.getInt("controlaEstoque") == 0 ? true : false);
        this.descontoGrupo = (venda.getInt("descontoGrupo") == 0 ? true : false);
        this.frete = (venda.getInt("frete") == 0 ? true : false);
        this.solicitaSenha = (venda.getInt("solicitaSenha") == 0 ? true : false);
        this.especialAlteraValor = (venda.getInt("especialAlteraValor") == 0 ? true : false);
        this.minimoPrazo = (venda.getInt("minimoPrazo") == 0 ? true : false);
        this.controlaGps = (venda.getInt("controlaGps") == 0 ? true : false);
        this.descontoPecentual = (venda.getInt("descontoPecentual") == 0 ? true : false);
