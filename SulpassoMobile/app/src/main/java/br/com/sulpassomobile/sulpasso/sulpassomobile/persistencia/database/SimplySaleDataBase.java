...
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Agenda;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Atividade;
...
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Configurador;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.ContasReceber;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Corte;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.CurvaAbc;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Devolucao;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Estoque;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Gravosos;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Grupo;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.GrupoBloqueadoCliente;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.GrupoBloqueadoNatureza;
...
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Kit;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Mensagem;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Meta;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Mix;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Motivos;
...
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.PrePedido;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.PrePedidoDireta;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Preco;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.PrecosClientes;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Promocao;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Status;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Tipologia;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.TiposVenda;
import br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Usuario;
...
{
    /*
    TODO: Voltar a versão do banco de dados par 1;
    TODO: Remover o código de onupdate;
     */
    ...
    {
        String sql = "UPDATE Pedidos set PedidosEnviado = 1 WHERE PedidosEnviado = 0";
        db.execSQL(sql);

        sql = "UPDATE Configurador set SequenciaPedidos = 2";
        db.execSQL(sql);
    }
}