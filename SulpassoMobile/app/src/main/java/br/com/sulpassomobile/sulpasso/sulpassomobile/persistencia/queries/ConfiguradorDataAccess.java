...
public class ConfiguradorDataAccess
{
    ...
    private Boolean inserirConfiguradorTelas(ConfiguradorTelas conta) throws InsertionExeption
    {
        ...
        this.sBuilder.append(
                br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Configurador.TELAINICIAL);
        this.sBuilder.append(") VALUES ('");
        this.sBuilder.append(conta.getEfetuaTroca());
        this.sBuilder.append("', '");
        this.sBuilder.append(conta.getVendasDireta());
        this.sBuilder.append("', '");
        this.sBuilder.append(conta.getMixIdeal());
        this.sBuilder.append("', '");
        this.sBuilder.append(conta.getMostraMeta());
        this.sBuilder.append("', '");
        this.sBuilder.append(conta.getCadastroCliente());
        this.sBuilder.append("', '");
        this.sBuilder.append(conta.getTipoFoco());
        this.sBuilder.append("', '");
