...
public class VendaDataAccess
{
    ...
    public List getByData() throws GenercicException
    {
        ...
        this.sBuilder.append(
            br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Venda.ENVIO);
        this.sBuilder.append(" = ");
        ...
        for(int i = 0; i < c.getCount(); i++)
        {
            ...
            venda.setBanco(
                c.getInt(c.getColumnIndex(
                br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Venda.BANCO)));
            venda.setTipo(
                c.getString(c.getColumnIndex(
                br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Venda.TIPO)));
            venda.setNatureza(
                c.getInt(c.getColumnIndex(
                br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Venda.NATUREZA)));
            ...
            int codPrazo = c.getInt(c.getColumnIndex(
                br.com.sulpassomobile.sulpasso.sulpassomobile.persistencia.tabelas.Venda.PRAZO));
