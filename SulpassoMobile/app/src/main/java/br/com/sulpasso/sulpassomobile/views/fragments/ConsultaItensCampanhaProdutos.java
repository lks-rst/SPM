 ...
 */
public class ConsultaItensCampanhaProdutos extends Fragment
{
    private ConsultaMinimosGravososKitsCampanhas consulta;

    public ConsultaItensCampanhaProdutos(){}
    /**********************************FRAGMENT LIFE CYCLE*********************************************/
    @Override
    ...
    {
        return inflater.inflate(R.layout.fragment_consulta_itens_campanhas_produtos, /*container, false*/null);
    }
...
/*******************************FRAGMENT FUNCTIONAL METHODS****************************************/
    ...
    public void listarItens() throws GenercicException
    {
        ...
        ((ListView) (getActivity().findViewById(R.id.liFcicpCampanhas))).setAdapter(adapter);
    }
