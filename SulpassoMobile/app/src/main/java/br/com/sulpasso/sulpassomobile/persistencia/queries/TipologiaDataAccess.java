...
public class TipologiaDataAccess
{
    ...
    private Boolean inserirGrupo(Tipologia tipologia) throws InsertionExeption
    {
        ...
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Tipologia.TABELA);
        this.sBuilder.append("(");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Tipologia.CODIGO);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Tipologia.DESCRICAO);
    ...
    private Boolean apagar(Tipologia d)  throws GenercicException
    {
        this.sBuilder.delete(0, this.sBuilder.length());
