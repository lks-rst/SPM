...
import br.com.sulpasso.sulpassomobile.modelo.Status;
...
public class StatusDataAccess
{
    ...
    private Boolean inserirGrupo(Status status) throws InsertionExeption
    {
        ...
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Status.TABELA);
        this.sBuilder.append("(");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Status.STATUS);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Status.PEDIDO);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Status.DATA);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Status.NOTA);
