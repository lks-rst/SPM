...
import br.com.sulpasso.sulpassomobile.modelo.Estoque;
...
public class EstoqueDataAccess
{
    ...
    private Boolean insertEstoque(Estoque estoque) throws InsertionExeption
    {
        ...
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Estoque.EMPRESA);
        this.sBuilder.append(", ");
        this.sBuilder.append(
    ...
    private Boolean apagar(Estoque d)  throws GenercicException
    {
        this.sBuilder.delete(0, this.sBuilder.length());
