...
import br.com.sulpasso.sulpassomobile.modelo.GrupoBloqueadoCliente;
...
public class GrupoBloqueadoClienteDataAccess
{
    ...
    private Boolean inserirGrupo(GrupoBloqueadoCliente g) throws InsertionExeption
    {
        ...
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.GrupoBloqueadoCliente.SUB);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.GrupoBloqueadoCliente.DIV);
    ...
    private Boolean apagar(GrupoBloqueadoCliente d)  throws GenercicException
    {
        this.sBuilder.delete(0, this.sBuilder.length());
