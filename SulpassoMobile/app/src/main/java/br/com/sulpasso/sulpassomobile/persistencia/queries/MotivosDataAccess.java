...
public class MotivosDataAccess
{
    ...
    private Boolean inserir(Motivos motivo) throws InsertionExeption
    {
        ...
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Motivos.TABELA);
        this.sBuilder.append("(");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Motivos.CODIGO);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.Motivos.DESCRICAO);
