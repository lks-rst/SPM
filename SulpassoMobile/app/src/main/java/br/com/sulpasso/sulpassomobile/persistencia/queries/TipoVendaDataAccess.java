...
public class TipoVendaDataAccess
{
    ...
    private Boolean inserirTiposVenda(TiposVenda tiposVenda) throws InsertionExeption
    {
        ...
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.TiposVenda.TABELA);
        this.sBuilder.append("(");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.TiposVenda.CODIGO);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.TiposVenda.DESCRICAO);
        this.sBuilder.append(", ");
        this.sBuilder.append(
                br.com.sulpasso.sulpassomobile.persistencia.tabelas.TiposVenda.MINIMO);
