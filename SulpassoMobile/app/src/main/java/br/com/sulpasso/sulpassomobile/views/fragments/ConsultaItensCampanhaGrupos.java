 ...
 */
public class ConsultaItensCampanhaGrupos extends Fragment
{
    private ConsultaMinimosGravososKitsCampanhas consulta;

    public ConsultaItensCampanhaGrupos(){}
    /**********************************FRAGMENT LIFE CYCLE*********************************************/
    @Override
    ...
    {
        return inflater.inflate(R.layout.fragment_consulta_itens_campanhas_grupos, /*container, false*/null);
    }
